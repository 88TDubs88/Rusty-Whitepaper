...
### An Onchain AI Learning Protocol
...
Learning is the most valuable onchain activity that does not yet exist.
...
RUSTY is not just a reward token.
...
Rusty rewards early supporters from Linea through a snapshot-based airdrop.
